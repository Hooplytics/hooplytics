...
from predictionHelpers import playerPositionInfo, restDaysInfo, opponentOppgInfo, seasonPeriodInfo, monthlyPeriods, convertDataToDataFrame, normalizeAndWeighData, getOpponentPointAllowed, upsertPredictionData, normalizeKeys
...
def main():
    ...
    # players = getPlayerSeasonStats().iloc[563:]
